...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_5.setGeometry(QtCore.QRect(170, 130, 521, 271))
        ...
        self.pages_Respuestas = QtWidgets.QStackedWidget(self.frame_5)
        self.pages_Respuestas.setObjectName("pages_Respuestas")
        self.page_Respuestas = QtWidgets.QWidget()
        self.page_Respuestas.setObjectName("page_Respuestas")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.page_Respuestas)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.scrollArea = QtWidgets.QScrollArea(self.page_Respuestas)
        self.scrollArea.setMaximumSize(QtCore.QSize(16777215, 189))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollArea_respuestas = QtWidgets.QWidget()
        self.scrollArea_respuestas.setGeometry(QtCore.QRect(0, 0, 481, 187))
        ...
        self.frame_Respuestas = QtWidgets.QFrame(self.scrollArea_respuestas)
        self.frame_Respuestas.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_Respuestas.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_Respuestas.setObjectName("frame_Respuestas")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.frame_Respuestas)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.label_respuesta = QtWidgets.QLabel(self.frame_Respuestas)
        self.label_respuesta.setMaximumSize(QtCore.QSize(100, 30))
        self.label_respuesta.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_respuesta.setObjectName("label_respuesta")
        self.horizontalLayout_8.addWidget(self.label_respuesta)
        self.textEdit_respuesta = QtWidgets.QTextEdit(self.frame_Respuestas)
        self.textEdit_respuesta.setMaximumSize(QtCore.QSize(350, 40))
        self.textEdit_respuesta.setStyleSheet("color: rgb(255, 255, 255);")
        self.textEdit_respuesta.setObjectName("textEdit_respuesta")
        self.horizontalLayout_8.addWidget(self.textEdit_respuesta)
        self.ch_verdadera = QtWidgets.QCheckBox(self.frame_Respuestas)
        self.ch_verdadera.setStyleSheet("color: rgb(255, 255, 255);")
        self.ch_verdadera.setObjectName("ch_verdadera")
        self.horizontalLayout_8.addWidget(self.ch_verdadera)
        self.verticalLayout_11.addWidget(self.frame_Respuestas)
        self.scrollArea.setWidget(self.scrollArea_respuestas)
        self.verticalLayout_12.addWidget(self.scrollArea)
        self.btn_siguienteRespuesta = QtWidgets.QPushButton(self.page_Respuestas)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_siguienteRespuesta.sizePolicy().hasHeightForWidth())
        self.btn_siguienteRespuesta.setSizePolicy(sizePolicy)
        self.btn_siguienteRespuesta.setMaximumSize(QtCore.QSize(50000, 72))
        self.btn_siguienteRespuesta.setStyleSheet("QPushButton {\n"
                                                  "    \n"
                                                  "    color: rgb(255, 255, 255);\n"
                                                  "    border: 2px solid rgb(52, 59, 72);\n"
                                                  "    border-radius: 5px;    \n"
                                                  ...
                                                  "    border: 2px solid rgb(43, 50, 61);\n"
                                                  "}")
        self.btn_siguienteRespuesta.setObjectName("btn_siguienteRespuesta")
        self.verticalLayout_12.addWidget(self.btn_siguienteRespuesta)
        self.pages_Respuestas.addWidget(self.page_Respuestas)
        ...
        self.label_numRes.setGeometry(QtCore.QRect(80, 60, 151, 41))
        ...
        self.spinBox_numRes.setGeometry(QtCore.QRect(300, 60, 111, 41))
        self.spinBox_numRes.setStyleSheet("color: rgb(255, 255, 255);")
        self.spinBox_numRes.setObjectName("spinBox_numRes")
        self.btn_crearRespuesta = QtWidgets.QPushButton(self.page_Num_Res)
        self.btn_crearRespuesta.setGeometry(QtCore.QRect(180, 190, 150, 30))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_crearRespuesta.sizePolicy().hasHeightForWidth())
        self.btn_crearRespuesta.setSizePolicy(sizePolicy)
        self.btn_crearRespuesta.setMaximumSize(QtCore.QSize(150, 30))
        self.btn_crearRespuesta.setStyleSheet("QPushButton {\n"
                                              "    \n"
                                              "    color: rgb(255, 255, 255);\n"
                                              "    border: 2px solid rgb(52, 59, 72);\n"
                                              "    border-radius: 5px;    \n"
                                              ...
                                              "    border: 2px solid rgb(43, 50, 61);\n"
                                              "}")
        self.btn_crearRespuesta.setObjectName("btn_crearRespuesta")
        self.label_preguntaError = QtWidgets.QLabel(self.page_Num_Res)
        self.label_preguntaError.setGeometry(QtCore.QRect(110, 130, 298, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_preguntaError.sizePolicy().hasHeightForWidth())
        self.label_preguntaError.setSizePolicy(sizePolicy)
        self.label_preguntaError.setMaximumSize(QtCore.QSize(5000, 25))
        self.label_preguntaError.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_preguntaError.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_preguntaError.setLineWidth(1)
        self.label_preguntaError.setText("")
        self.label_preguntaError.setScaledContents(False)
        self.label_preguntaError.setAlignment(QtCore.Qt.AlignCenter)
        self.label_preguntaError.setObjectName("label_preguntaError")
        self.pages_Respuestas.addWidget(self.page_Num_Res)
        self.verticalLayout_10.addWidget(self.pages_Respuestas)
        ...
        self.pages_test_create.setCurrentIndex(1)
        self.pages_Respuestas.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_respuesta.setText(_translate("MainWindow", "Respuesta A"))
        self.textEdit_respuesta.setPlaceholderText(_translate("MainWindow", "Introduce tu respuesta"))
        self.ch_verdadera.setText(_translate("MainWindow", "Verdadera?"))
        self.btn_siguienteRespuesta.setText(_translate("MainWindow", "Crear Respuesta"))
        self.label_numRes.setText(_translate("MainWindow", "Número de respuestas"))
        self.btn_crearRespuesta.setText(_translate("MainWindow", "Generar Respuestas"))
